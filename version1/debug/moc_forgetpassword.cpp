...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_ForgetPassword_t, stringdata0) + ofs \
...
QT_MOC_LITERAL(1, 15, 18), // "ForgetPasswordBack"
...
QT_MOC_LITERAL(5, 81, 23) // "on_pushButton_2_clicked"
    ...
    "ForgetPassword\0ForgetPasswordBack\0\0"
...
void ForgetPassword::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ForgetPassword *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ForgetPasswordBack(); break;
        ...
        {
            using _t = void (ForgetPassword::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ForgetPassword::ForgetPasswordBack)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject ForgetPassword::staticMetaObject = { {
    &QMainWindow::staticMetaObject,
    qt_meta_stringdata_ForgetPassword.data,
    qt_meta_data_ForgetPassword,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ForgetPassword::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ForgetPassword.stringdata0))
...
// SIGNAL 0
void ForgetPassword::ForgetPasswordBack()
{
